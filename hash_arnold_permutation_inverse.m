function hash = hash_arnold_permutation_inverse(matrix, index_in,block_split, instability_repeat, nb_bit)
    index_in = index_in -1;
	...
	% disp('periode');
    % disp(periode);
    matrix_permute = arnold_permutation_inverse(matrix, instability_repeat+periode);
