function hash = hash_luca_permutation(matrix, index_in,block_split, instability_repeat, nb_bit)
    index_in = index_in -1;
	...
	% disp('periode');
    % disp(periode);
    matrix_permute = luca_permutation(matrix, instability_repeat+periode);
